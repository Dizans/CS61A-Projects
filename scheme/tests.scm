...
;;NOTE: WE HAD SOME TESTS ERROR ON PURPOSE TO TEST IF THE INTERPRETER TOOK THAT INTO ACCOUNT;;
...
(substitute '((lead guitar) (bass guitar) (rhythm guitar) drums)
                             'guitar 'axe)
; expect '((lead axe) (bass axe) (rhythm axe) drums)
...
(substitute-list
                  ...
                  '(1 2 3 4)
                  '(one two three four))
; expect '((four calling birds) (three french hens) (two turtle doves))
